...
public:
	CGHost *m_GHost;
	string classCallString, CC[12], CCstatic[12];	//AutoCC 171118 AC
	bool CCStarted;												//AutoCC 171118 AC

protected:
	uint32_t m_GameLoadedTime;   					// GetTime when the game was loaded //AutoCC 171118 AC
